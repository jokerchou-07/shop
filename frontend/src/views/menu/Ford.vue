  ...
  <div class="product-list">
    ...
    <ul class="product-grid">
      ...
      @mouseenter="startCarousel(index)" @mouseleave="stopCarousel(index)">
        <h2>
          <img :src="item.imgUrls[currentImageIndex[index]]" alt="">
        </h2>
        <div class="price">
          <h3>{{ item.name }}</h3>
          <p>價格: {{ item.price }} 元</p>
      ...
      products: [
        {
          ...
          name: "Ranger",
          price: 100,
          imgUrls: ["/Ford1.png", "/Ford2.png", "/Ford3.png"]
        },
        {
          id: 2,
          name: "Mondeo",
          price: 150,
          imgUrls: ["/Ford2.png", "/Ford2.png", "/Ford3.png"]
        },
        {
          id: 3,
          name: "Fiesta",
          price: 150,
          imgUrls: ["/Ford3.png", "/Ford2.png", "/Ford3.png"]
        },
      ],
    };
  },
